package com.wy.devicerecycle.code2.activity;
...
import com.wy.devicerecycle.code2.camera.CameraManager;
import com.wy.devicerecycle.code2.common.AmbientLightManager;
import com.wy.devicerecycle.code2.common.BeepManager;
import com.wy.devicerecycle.code2.common.BitmapUtils;
import com.wy.devicerecycle.code2.common.InactivityTimer;
import com.wy.devicerecycle.code2.common.IntentSource;
import com.wy.devicerecycle.code2.decode.BitmapDecoder;
import com.wy.devicerecycle.code2.decode.CaptureActivityHandler;
import com.wy.devicerecycle.code2.decode.FinishListener;
import com.wy.devicerecycle.code2.view.ViewfinderView;
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (result != null) {
                                    ...
                                    String resultStr = ResultParser.parseResult(result).toString();
                                    m.obj = resultStr;
